<x-app-layout>
                            ...
                            <td>
                                @if($purchase->payment_method)
                                    <span class="badge bg-secondary">
                                        {{ strtoupper(str_replace('_', ' ', $purchase->payment_method)) }}
                                    </span>
                                @else
                                    N/A
                                @endif
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="{{ route('purchases.show', $purchase) }}"><i class="bi bi-eye"></i> View</a></li>
                                        <li><a class="dropdown-item" href="{{ route('purchases.edit', $purchase) }}"><i class="bi bi-pencil"></i> Edit</a></li>
                ...
                <div class="modal-body">
                    <form action="#" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="alert alert-info small">
                            <i class="bi bi-info-circle"></i> Download the sample template.
    ...
    <script>
        ...
        function exportExcel() {
            alert('Excel export requires Laravel Excel package.');
        }
