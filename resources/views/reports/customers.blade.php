                ...
                buttons: [
                    ...
                    { 
                        ...
                        customize: function(doc) {
                            ...
                            var totalSales = '{{ number_format($totals["total_sales"], 2) }}';
                                ...
                                table: {
                                    ...
                                    body: [
                                        [
                                            ...
                                            {text: totalSales, alignment: 'right', bold: true, fillColor: '#e9ecef'},
                    ...
                    { 
                        ...
                        customize: function(win) {
                            ...
                            $(win.document.body).find('table').after(
                                ...
                                '<td style="text-align:right; padding:8px; border:1px solid #ddd; width:120px;">Sales: ' + totalSales + '</td>' +
